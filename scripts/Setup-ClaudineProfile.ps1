...
# Generated by: Setup-ClaudineProfile.ps1
# Date: $(Get-Date -Format 'yyyy-MM-dd HH:mm:ss')

# Only activate if:
# 1. We're in the Claudine workspace directory tree
# 2. Environment is not already activated
# 3. claudineENV.ps1 exists

`$claudineWorkspace = "$ClaudineWorkspace"
`$claudineEnvScript = "$ClaudineEnvScript"
